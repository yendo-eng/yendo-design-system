...
/// Variant: Cash back / Powered
///
/// Same layout as Control (APR/Fees) but replaces the APR + annual fee
/// line with a cash-back / security benefit line per card.
class OffersSelectionScreenCashback extends StatefulWidget {
  const OffersSelectionScreenCashback({
    super.key,
  ...
  @override
  State<OffersSelectionScreenCashback> createState() =>
      _OffersSelectionScreenCashbackState();
}

class _OffersSelectionScreenCashbackState
    extends State<OffersSelectionScreenCashback> {
  ...
  /// Benefit line shown per card name instead of APR/Annual fee.
  static const Map<String, String> _benefitLines = {
    'Platinum Rewards': '1.5% cash back*  |  Powered by your car',
    'Signature Rewards': '1.5% cash back*  |  Powered by home fixtures',
    'Premier Rewards': '1.5% cash back*',
  };
        ...
        content: [
          ...
          ...widget.offers.asMap().entries.map((e) => Padding(
                ...
                child: OfferCardWidget(
                  ...
                  showAnnualFee: false,
                  showViewTerms: false,
                  benefitLine: _benefitLines[e.value.name],
                  extraBottomPadding: 10.0,
                  imageScale: 0.85,
                ),
              )),

          // ── View terms — always active ───────────────────────────────────
          Center(
