...
/// Option A — Credit Emphasis no APR w/VH
///
/// Identical layout to Option A, with one change:
/// tapping "Get your credit card" opens the Verification Hub
/// in a full-height bottom sheet instead of navigating to FPO.
class OffersSelectionScreenVH extends StatefulWidget {
  const OffersSelectionScreenVH({
    super.key,
  ...
  @override
  State<OffersSelectionScreenVH> createState() =>
      _OffersSelectionScreenVHState();
}

class _OffersSelectionScreenVHState extends State<OffersSelectionScreenVH> {
  ...
  /// Opens the Verification Hub in a full-height bottom sheet.
