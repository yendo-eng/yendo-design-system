...
/// Verification Hub — Premier Rewards variant.
/// Shows the Premier Rewards card image.
/// Steps start at "Confirm your identity" (no vehicle step).

class VerificationHubScreenPremier extends StatelessWidget {
  const VerificationHubScreenPremier({
    super.key,
        ...
        if (showHeroCard) ...[
          Padding(
            ...
            child: ClipRRect(
              ...
              child: Image.asset(
                'assets/images/Premier Rewards.png',
                fit: BoxFit.cover,
