...
import 'verification_hub_screen_premier.dart';

/// VH — Premier Rewards variant
///
/// Pre-approval offer selection screen whose CTA opens the
/// Verification Hub (Premier Rewards) in a full-height bottom sheet.
class OffersSelectionScreenVHPremier extends StatefulWidget {
  const OffersSelectionScreenVHPremier({
    super.key,
  ...
  @override
  State<OffersSelectionScreenVHPremier> createState() =>
      _OffersSelectionScreenVHPremierState();
}

class _OffersSelectionScreenVHPremierState
    extends State<OffersSelectionScreenVHPremier> {
  ...
  /// Opens the Verification Hub (Premier Rewards) in a full-height bottom sheet.
              ...
              children: [
                ...
                Expanded(
                  child: MediaQuery.removePadding(
                    context: context,
                    removeTop: true,
                    child: VerificationHubScreenPremier(
